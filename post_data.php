<html>
		    ...
		    <nav class="navbar navbar-default">
        		<div class="container-fluid">
		          <div class="navbar-header">
		            ...
		            <a class="navbar-brand" href="#">Dev Assign 2</a>
		          </div>
    ...
    $username = "id1210288_root";
    $password = "nikhil412";
    $database = "id1210288_contact";
    $newURL= "./contact.php";
    $time_stamp = date('c',time());
    
    // Create connection
    $db = mysqli_connect('localhost','id1210288_root' , 'nikhil412', 'id1210288_contact');
